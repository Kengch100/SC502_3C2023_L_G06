        ...
        <div class="container py-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">Salon de Belleza siempre a tu disposición</h1>
                    ...
                    <div class="row pt-3">
                        <div class="col-6">
                            <div class="bg-light text-center p-4">
                                ...
                                <h6 class="text-uppercase">Estilistas</h6>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="bg-light text-center p-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="hours-text bg-light p-4 p-lg-5 my-lg-5">
                        ...
                        <h1 class="mb-4">El mejor tratamiento facial que ofrecemos</h1>
                        <p>Dolores lorem lorem ipsum sit et ipsum. Sadip sea amet diam dolore sed et. Sit rebum labore sit sit ut vero no sit. Et elitr stet dolor sed sit et sed ipsum et kasd ut. Erat duo eos et erat sed diam duo</p>
                        <ul class="list-inline">
                            <li class="h6 py-1"><i class="far fa-circle text-primary mr-3"></i>Lun – Vie : 9:00 AM - 18:00 </li>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5">
            <div class="row justify-content-center text-center">
                <div class="col-lg-6">
                    <h6 class="d-inline-block bg-light text-primary text-uppercase py-1 px-2">Especialistas</h6>
                    <h1 class="mb-5">Estilistas</h1>
                </div>
            </div>
            <div class="row">
